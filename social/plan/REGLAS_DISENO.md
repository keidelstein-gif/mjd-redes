# Reglas de diseño (aprendidas en producción)
...
2. **Footer MDJ un poco más grande — es el CTA a la app.** El wordmark
   (MI DÍA JUDÍO / MY JEWISH DAY) + la URL van con **más presencia**: es lo que **lleva
   tráfico a la app**. Legible de un vistazo, en crema/oro, sin robarle el protagonismo a
   la frase. (No es letra chica de copyright: es la invitación a buscarnos.)

3. **Jerusalén con intención.** La Cúpula de la Roca (cúpula dorada) ocupa hoy el lugar
   del Beit HaMikdash → **nunca en piezas de duelo por el Templo** (Nueve Días, Tishá
   BeAv, 10 de Tevet), y con cuidado en general. Preferir el **Kotel, las murallas, la
   Torre de David**, o piedra genérica. Ninguna cúpula dorada ni minarete en contexto de duelo.

4. **La luna nunca afirma un lado en cuenta global.** Una creciente se ilumina por la
   **derecha** en el hemisferio **norte** y por la **izquierda** en el **sur** (flip de
   hemisferio): cualquier orientación nítida se lee «al revés» para media audiencia.
   → **Velar la luna, insinuarla o dejarla de frente**; nunca un terminador marcado.
